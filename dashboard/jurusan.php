...
// Get all jurusan
$query = "SELECT * FROM jurusan ORDER BY kode_jurusan ASC";
...
<head>
    ...
    <title>Data Jurusan - SMKN 2 Bengkalis</title>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card table-card">
                        <div class="card-header bg-white d-flex justify-content-between align-items-center">
                            ...
                            <a href="jurusan_form.php" class="btn btn-primary">
                                        ...
                                        <?php if ($result->num_rows > 0): ?>
                                            <?php $no = 1; while ($row = $result->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td><strong><?php echo $row['nama_jurusan']; ?></strong></td>
                                                    <td><?php echo substr($row['deskripsi'], 0, 100) . '...'; ?></td>
                                                    <td class="text-center">
                                                        <a href="jurusan_form.php?edit=<?php echo $row['id']; ?>" 
                                                           class="btn btn-sm btn-warning btn-action">
                                                            <i class="bi bi-pencil"></i> Edit
                                                        </a>
                                                        <a href="jurusan.php?delete=<?php echo $row['id']; ?>" 
